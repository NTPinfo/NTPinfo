...
test('Passing Data', () => {
    const ntpData: NTPData = {
        ...
        ref_id: "GPSs",
        client_sent_time: 3959231207,
        server_recv_time: 3959231207,
        server_sent_time: 3959231207,
        client_recv_time: 3959231207,
        offset: Number(import.meta.env.VITE_STATUS_THRESHOLD)-10,
        RTT: 5.405,
        stratum: 1,
        precision: -20,
        root_delay: 0,
    ...
    const ripeData: RIPEData = {
        measurementData: {
            ...
            ref_id: "GPSs",
            client_sent_time: 3959232158,
            server_recv_time: 3959232158,
            server_sent_time: 3959232158,
            client_recv_time: 3959232158,
            offset: Number(import.meta.env.VITE_STATUS_THRESHOLD)-10,
            RTT: 2.09,
            stratum: 1,
...
test('Caution Data - NTP higher', () => {
    const ntpData: NTPData = {
        ...
        ref_id: "GPSs",
        client_sent_time: 3959231207,
        server_recv_time: 3959231202,
        server_sent_time: 3959231202,
        client_recv_time: 3959231207,
        offset: Number(import.meta.env.VITE_STATUS_THRESHOLD)+100,
        RTT: 5.405,
        stratum: 1,
        precision: -20,
        root_delay: 0,
